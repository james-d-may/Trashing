        ...
        callback: function (e) {
            ...
            if (v)
                for (c = c.getElementsByClassName("tweet"); d < c.length;) {
                  var author = c[d].getElementsByClassName("p-author")[0].firstElementChild;
                  author.removeChild(author.firstElementChild);
                  author.removeChild(author.firstElementChild);
                    ...
                    for (c = p(c, "tweet"); d < c.length;) e.push(p(c[d], "e-entry-title")[0]), h.push(c[d].getAttribute("data-tweet-id")), g.push(p(c[d], "p-nickname")[0]), f.push(p(c[d], "dt-updated")[0]), 0 < p(c[d], "retweet-credit").length ? a.push(!0) : a.push(!1), d++;
